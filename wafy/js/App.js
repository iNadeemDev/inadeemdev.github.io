...
// ##### Fetch client's configurations ##### //

// object to store fetched configs
var wafy_config_data = {};

// fetching configurations
fetch('https://bff7fb01-0465-4e37-be7c-a89266a3f96e.mock.pstmn.io/configs')   // POSTMAN= https://bff7fb01-0465-4e37-be7c-a89266a3f96e.mock.pstmn.io/configs
    .then(res => res.json())
    .then(data => {
        wafy_config_data = data;
        console.log(wafy_config_data);
...
function WafyLoadWidget() {
    ...
    wafy_css_link.href = 'https://nadeemdev.com/wafy/css/wafy-styles.css';
        ...
        <div class="wafy-menu-wrapper">
            ...
            <div class="wafy-color-wrapper" id="wafy-color-wrapper">
                ...
                <div class="wafy-menu">
                    ...
                    <div class="wafy-menu-card" id="wafy-text-color">
                        <svg class="wafy-menu-icons" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path
                                d="M256 48C141.1 48 48 141.1 48 256v40c0 13.3-10.7 24-24 24s-24-10.7-24-24V256C0 114.6 114.6 0 256 0S512 114.6 512 256V400.1c0 48.6-39.4 88-88.1 88L313.6 488c-8.3 14.3-23.8 24-41.6 24H240c-26.5 0-48-21.5-48-48s21.5-48 48-48h32c17.8 0 33.3 9.7 41.6 24l110.4 .1c22.1 0 40-17.9 40-40V256c0-114.9-93.1-208-208-208zM144 208h16c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H144c-35.3 0-64-28.7-64-64V272c0-35.3 28.7-64 64-64zm224 0c35.3 0 64 28.7 64 64v48c0 35.3-28.7 64-64 64H352c-17.7 0-32-14.3-32-32V240c0-17.7 14.3-32 32-32h16z" />
                        </svg>
                        <div class="wafy-menu-title">Text Color</div>
                    </div>
                    <div class="wafy-menu-card" id="wafy-background-color">
                        <svg class="wafy-menu-icons" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path
                                d="M256 48C141.1 48 48 141.1 48 256v40c0 13.3-10.7 24-24 24s-24-10.7-24-24V256C0 114.6 114.6 0 256 0S512 114.6 512 256V400.1c0 48.6-39.4 88-88.1 88L313.6 488c-8.3 14.3-23.8 24-41.6 24H240c-26.5 0-48-21.5-48-48s21.5-48 48-48h32c17.8 0 33.3 9.7 41.6 24l110.4 .1c22.1 0 40-17.9 40-40V256c0-114.9-93.1-208-208-208zM144 208h16c17.7 0 32 14.3 32 32V352c0 17.7-14.3 32-32 32H144c-35.3 0-64-28.7-64-64V272c0-35.3 28.7-64 64-64zm224 0c35.3 0 64 28.7 64 64v48c0 35.3-28.7 64-64 64H352c-17.7 0-32-14.3-32-32V240c0-17.7 14.3-32 32-32h16z" />
                        </svg>
                        <div class="wafy-menu-title">Background Color</div>
                    </div>
                </div>
            </div>
            ...
            <div class="wafy-alignment-wrapper" id="wafy-alignment-wrapper">
                ...
                <div class="wafy-menu">
                    ...
                    <div class="wafy-menu-card" id="wafy-dyslexia">
                        ...
                        <div class="wafy-menu-title">Deslexia Friendly</div>
                    </div>
        ...
        if (wafy_isSetVoice == false) {
            ...
            if ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window) {
                ...
                function recognitionResult(event) {
                    console.log("recognition Result are here.")
                    console.log(event);
